...
const LESSON_STEPS: LessonStep[] = [
  {
    ...
    tasks: [
      ...
      makeTask("1-5", "At trække et hjerter i et kortspil.", ["umuligt", "usandsynligt", "lige sandsynligt", "sandsynligt"], "usandsynligt", "Hvor stor en del af kortene er hjerter?", "13 af 52 kort er hjerter, altså 1/4.", { numerator: 1, denominator: 4 }),
